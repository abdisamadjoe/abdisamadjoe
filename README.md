...
[![My Skills](https://skillicons.dev/icons?i=figma,tailwind,nextjs,react,nodejs,express,ts,postgres,redis,flutter,aws,ubuntu,docker,kubernetes,prometheus,grafana,kali&theme=light&perline=50)](https://skillicons.dev)
